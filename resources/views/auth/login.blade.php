    ...
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{ route('login') }}">
                ...
                @if (session('mensaje'))
                    <p class="bg-red-500 rounded-lg text-white my-2 text-sm p-2 text-center">{{ session('mensaje') }}</p>
                @endif
                <div class="mb-5">
                    ...
                    <input class="border p-3 w-full rounded-lg @error('email') border-red-500 @enderror" type="text"
                        name="email" placeholder="Tu Email de Registro" id="email" value="{{ old('email') }}">
                ...
                <div class="mb-5">
                    ...
                    <input class="border p-3 w-full rounded-lg @error('password') border-red-500 @enderror" type="password"
                        name="password" placeholder="Tu Password de Registro" id="password">
